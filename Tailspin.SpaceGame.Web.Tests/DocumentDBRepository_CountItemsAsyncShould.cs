...
{
    /**
     * This test should pass because it is a copy of GetItemsAsyncShould.cs file with class name change.
     */
    public class DocumentDBRepository_CountItemsAsyncShould
    {
